    ...
    while True:
        ...
        for result in results:
            for box in result.boxes:
                ...
                if object_type.lower() not in TARGET_OBJECTS:
                    continue
        ...
        for future, box, object_type, confidence in futures:
            ...
            # Red boxes for drones and airplanes
            color = (0, 0, 255)  # Always red for our target objects
        ...
        # Add a status message showing what we're tracking
        cv2.putText(frame, f"Tracking: {', '.join(TARGET_OBJECTS)}", (10, 50), 
        ...
        cv2.imshow("Drone & Airplane Tracking", frame)
